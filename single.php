                      ...
                      <div style="border: 3px solid #f0f0f0">
                          ...
                          <div style="padding:10px 10px 15px 0px;height: 85px">
                            ...
                            <div style="width: 50%;float: left;">
                              ...
                              <input type="text" readonly required style="font-size:18;border:none;border-bottom:1px solid #999999;width: 90%;text-align: left;padding-left: 35px;display: inline;margin-left: 15px;margin-bottom:10px;background: url('/templates/car/images/placeholder.png') no-repeat left center;background-size: 30px 30px;color:black" readonly value="321" >
                            </div>
                          </div>
                          <!--Select 2-->
                          <div style="margin-top: 10px">
                            <label style="padding:10px;margin-left:10px;display:block;color:#f64512;font-size:18px" name="address-car" class="form-custom-label form-custom-label-outside hehe">Ngày giờ thuê:</label>
                               ...
                               <input name="ngaythue" type="text" name="pickup-date" required style="border:none;border-bottom:1px solid #999999;width: 55%;text-align: right;display: inline;margin-left: 15px;background: url('/templates/car/images/calendar.png') no-repeat left center;font-size:16px;background-size: 30px 30px;color:black" value="1" readonly >
                               
                               <input name="giothue" type="text" style="border:none;border-bottom:1px solid #999999;font-size:20px;width: 80px;text-align: right;display: inline;margin-left: 20px;background: url('/templates/car/images/clock.png') no-repeat left center;background-size: 30px 30px;color:black" value="4" readonly />
                          </div>    
                          ...
                          <div>
                            <label style="padding:20px 10px 10px 10px;margin-left:10px;display:block;color:#f64512;font-size:18px" name="address-car" class="form-custom-label form-custom-label-outside hehe">Ngày giờ trả:</label>
                               ...
                               <input name="ngaytra" type="text" name="pickup-date" data-time-picker="date" required style="border:none;border-bottom:1px solid #999999;width: 55%;text-align: right;display: inline;margin-left: 15px;background: url('/templates/car/images/calendar.png') no-repeat left center;font-size:16px;background-size: 30px 30px;color:black" value="2" readonly >
                          ...
                          <div>
                            <label style="padding:30px 10px 10px 10px;margin-left:10px;display:block;color:#f64512;font-size:18px" name="address-car" class="form-custom-label form-custom-label-outside hehe">Giá tiền/Giờ: <span style="color:#666">321</span></label>
                            <label style="padding:10px 10px 10px 10px;margin-left:10px;display:block;color:#f64512;font-size:18px" name="address-car" class="form-custom-label form-custom-label-outside hehe">Tổng tiền: <span style="color:#666">123</span></label>
